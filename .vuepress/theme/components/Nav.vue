<template>
 <nav class="nav flex items-center justify-between flex-wrap p-6 text-right">
  <a href="/" class="text-serif block m-4">
    <img src="../assets/initials.png"/>
  </a>
      
  <div class="block lg:hidden">
    <button class="flex items-center px-3 py-2 border rounded text-blue-darkest border-blue-darkest hover:text-blue-darker hover:border-blue-darkest">
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div class="nav-text text-med lg:flex-grow">
      <span v-for="item in $site.themeConfig.nav" >
        <a :href="item.link" class="block m-4 lg:inline-block lg:mt-0 no-underline text-blue-darker hover:text-blue-darkest">
          {{item.text}}
        </a>
      </span>
      
      <a class="m-4 no-underline text-blue-darker" href="http://github.com/jlooper">
      ...
      <a class="m-4 no-underline text-blue-darker" href="http://twitter.com/jenlooper">
