...
<div class="text-center">
    <div class="flex flex-wrap pt-10 m-2 justify-center"> 
        <div class="lg:flex">
            <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center" style="background-image: url('./images/jenlooper.jpg')" title="Jen Looper">
            </div>
