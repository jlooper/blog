    ...
    <div class="px-2 mt-0 lg:mt-2 md:mt-0 sm:mt-0">
      <div class="flex flex-wrap -mx-2">
        <div class="w-full lg:w-1/2 px-2">
          <div class="h-56 bg-gray-100 card">
            <div
              class="inline-block align-top cursor-pointer"
              @click="goToSite('https://frontendfoxes.org')"
            >
              <p class="text-4xl p-2 text-center font-bold underline">Front-End Foxes</p>

              <p
                class="inline-block text-2xl p-2 align-top"
        ...
        <div class="w-full lg:w-1/2 px-2">
          <div class="h-56 bg-gray-100 card">
            ...
            >
              <p class="text-4xl p-2 text-center font-bold underline">Practice Buddy</p>
